...
$(document).ready(function () {
  ...
  gsap.registerPlugin(ScrollTrigger); // topslider
  ...
  */
  ...
  smoothScroll("#scrollContent"); // this is the helper function that sets it all up. Pass in the content <div> and then the wrapping viewport <div> (can be the elements or selector text). It also sets the default "scroller" to the content so you don't have to do that on all your ScrollTriggers.
  ...
  $("input, select").styler(); // slide frame animation
